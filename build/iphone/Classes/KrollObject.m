...
//@interface PicPocketObject : NSObject
//@end

@interface PicPocketObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PicPocketObject class]])
		{
			for (NSString *key in [[(PicPocketObject*)o modules] allKeys])
			{
